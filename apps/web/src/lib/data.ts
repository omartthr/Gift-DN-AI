...
export const GIFT_RESULTS: Record<string, GiftResult[]> = {
  tr: [
    ...
    { rank: 2, name: "Yün Battaniye, Doğal Boya", query: "yün battaniye doğal boya", tone: "rose", desc: "Anadolu yünü, kök boya. 130×180 cm.", why: "'Doğal & rahat' tarzıyla doğrudan örtüşüyor. Hediye sebebi 'sebep yok' olduğu için sembolikten çok günlük kullanılır bir şey önerdim.", price: "₺ 2.250", store: "Karya", stock: "Stokta · 4 adet" },
    { rank: 3, name: "Şiir Antolojisi, Birinci Baskı", query: "ikinci el şiir kitabı", tone: "clay", desc: "1996 baskısı, sertifikalı sahaflıktan.", why: "'Okumak' ilgisi ve 'küçük jestler' sevgi dili bir araya gelince, bir kitap ama özel bir kitap mantıklı geldi. Birinci baskı, hediyenin 'düşünülmüş' olduğunu gösteriyor.", price: "₺ 680", store: "Hazan Sahaf", stock: "Stokta · 1 adet" },
  ],
  en: [
    { rank: 1, name: "Handmade Ceramic Tea Set", query: "handmade ceramic teapot", tone: "sage", desc: "Matte-glazed pot and two cups with simple form. Made in Türkiye.", why: "The quiz pointed to quiet, at-home rituals. It fits both 'natural' and 'classic' notes. Being handmade echoes the personal vibe of past wins like a handmade notebook.", price: "₺ 1,480", store: "İlbey Atelier", stock: "In stock · 2 left" },
    { rank: 2, name: "Wool Blanket, Plant-Dyed", query: "wool blanket plant dyed", tone: "rose", desc: "Anatolian wool, madder root dye. 130×180 cm.", why: "Direct fit with 'natural & easy'. Since the occasion is 'no reason', I steered toward an everyday object over something symbolic.", price: "₺ 2,250", store: "Karya", stock: "In stock · 4 left" },
    { rank: 3, name: "Poetry Anthology, First Edition", query: "first edition poetry book", tone: "clay", desc: "1996 printing, certified rare-books dealer.", why: "'Reading' as an interest plus 'small gestures' as love language makes a book — but a special book — the right move. The first-edition framing signals the gift was thought about.", price: "₺ 680", store: "Hazan Rare Books", stock: "In stock · 1 left" },
  ],
};
...
export const BUDGETS = {
  tr: { b1: "0 – 250 ₺", b2: "250 – 500 ₺", b3: "500 – 1.000 ₺", b4: "1.000 – 3.000 ₺", b5: "3.000 ₺ +" },
  en: { b1: "₺0 – 250", b2: "₺250 – 500", b3: "₺500 – 1,000", b4: "₺1,000 – 3,000", b5: "₺3,000 +" },
};
