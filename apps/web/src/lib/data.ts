...
export const COMMUNITY_FEED: CommunityPost[] = [
  { id: "p1", tone: "sage", productName: "Lego Classic Seti", store: "Lego Store", forTr: "Kendim için", forEn: "For myself", textTr: "Hafta sonları kafamı boşaltmak için birebir.", textEn: "Perfect for clearing my head on weekends.", author: "Selin K.", anon: false, likes: 142, h: 320, image: "/images/lego.jpg" },
  { id: "p2", tone: "rose", productName: "Oyuncak Ev Seti", store: "Atölye Ev", forTr: "Sevgilim için", forEn: "For my partner", textTr: "Birlikte yapma sebebi olsun istedim. Üç hafta sonra hâlâ konuşuyoruz.", textEn: "Wanted us to do something together. Three weeks later we're still talking about it.", author: "Anonim", anon: true, likes: 98, h: 260, image: "/images/atolye_ev.jpg" },
  { id: "p3", tone: "clay", productName: "İkinci El Plaklar, 3'lü", store: "Plak Plak", forTr: "Arkadaşım için", forEn: "For my friend", textTr: "Üçü de 90'lar Türk pop. Açar açmaz sessizleşip dinledi, sonra bana sarıldı.", textEn: "All three 90s Turkish pop. He went quiet, listened, then hugged me.", author: "Mert A.", anon: false, likes: 211, h: 380, image: "/images/plak.jpg" },
...
export const WHEEL_GIFTS: Record<string, WheelGift[]> = {
  tr: [
    ...
    { id: "wg5", name: "Aromaterapi Mum", price: "₺220", store: "Işık & Koku", link: "https://example.com/candle", image: "/images/mum.jpg", tone: "cream" },
  ...
  en: [
    ...
    { id: "wg5", name: "Aromatherapy Candle", price: "₺220", store: "Light & Scent", link: "https://example.com/candle", image: "/images/mum.jpg", tone: "cream" },
